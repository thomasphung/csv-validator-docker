...
If you want to build the whole project, run `mvn clean package` on the project's root directory. The project's .zip file will be located in /csv-validator-distribution/target.
